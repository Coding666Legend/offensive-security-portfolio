...
const description =
  "Aditya Khaire is a Senior Frontend Engineer specializing in React, TypeScript, and modern web technologies. Explore his portfolio and projects.";

export const metadata: Metadata = {
  title: "Aditya Khaire – CyberSecurity Enthusiast",
